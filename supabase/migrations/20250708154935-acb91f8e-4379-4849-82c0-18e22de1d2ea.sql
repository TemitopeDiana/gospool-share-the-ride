-- Complete the July 4th database elements restoration

-- 1. Update donation policies (from 20250704090000_update_donation_policies.sql)
...
-- 2. Create pending_changes table (from 20250704095422)
...
-- 3. Create enhanced security functions (from 20250705145708)
...
-- 4. Create pending changes management functions (from 20250704100635)
...
-- 5. Update has_permission function with proper security
...
-- 6. Create function to assign super admin role
...
-- 8. Assign super admin role to temitopediana1@gmail.com
