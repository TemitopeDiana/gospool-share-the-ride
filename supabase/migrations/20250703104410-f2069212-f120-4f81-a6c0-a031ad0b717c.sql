...
('Free Church Transportation Network', 'Connecting church communities across Nigeria with reliable and affordable transportation solutions. This project aims to bridge the gap between isolated communities and their places of worship.', 'active', 'Lagos, Nigeria', 500000, 75, '2024-01-15', '2024-12-31', '/images/Logo mark v2 dark.png'),
('Community Outreach Programs', 'Expanding our reach to rural communities through mobile church services and community support programs. Bringing faith and hope to underserved areas.', 'active', 'Abuja, Nigeria', 300000, 60, '2024-03-01', '2024-11-30', '/images/Logo mark v2 dark.png'),
('Digital Faith Platform', 'Developing a comprehensive digital platform for churches to manage their congregations, events, and community outreach effectively.', 'active', 'Port Harcourt, Nigeria', 750000, 40, '2024-06-01', '2025-05-31', '/images/Logo mark v2 dark.png')
