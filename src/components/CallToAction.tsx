  ...
  return (
    <section className="py-20 bg-gradient-to-r from-brand-primary via-brand-dark-teal to-brand-mint dark:from-brand-dark-teal dark:via-brand-primary dark:to-brand-mint relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="text-xl text-brand-light-mint/90 mb-8 max-w-2xl mx-auto font-ibm-plex">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" className="bg-white text-brand-primary hover:bg-brand-light-mint hover:text-brand-dark-teal px-8 py-3 text-lg shadow-xl transform hover:scale-105 transition-all duration-300 font-poppins">
            Get Started Free
          </Button>
          <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-brand-primary px-8 py-3 text-lg shadow-xl transform hover:scale-105 transition-all duration-300 font-poppins">
            <Link to="/sponsorship">
